...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface QuotePreviewInvoiceListParams extends PaginationParams {
      /**
       * Specifies which fields in the response should be expanded.
       */
      expand?: Array<string>;
    ...
    interface QuotePreviewSubscriptionScheduleListParams
    ...
    class QuotesResource {
      ...
      listPreviewInvoices(
        id: string,
        params?: QuotePreviewInvoiceListParams,
        options?: RequestOptions
      ...
      listPreviewSubscriptionSchedules(
        id: string,
        params?: QuotePreviewSubscriptionScheduleListParams,
        options?: RequestOptions
