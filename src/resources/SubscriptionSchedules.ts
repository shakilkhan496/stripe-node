...
namespace Stripe {
  ...
  namespace SubscriptionScheduleCreateParams {
    export interface DefaultSettings {
       ...
       */
      billing_thresholds?: Stripe.Emptyable<DefaultSettings.BillingThresholds>;
  ...
  export interface SubscriptionSchedulesResource {
    create:
      | ((
...
const resource: SubscriptionSchedulesResource = StripeResource.extend({
