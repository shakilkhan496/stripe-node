...
namespace Stripe {
  ...
  export interface ChargesResource {
    create:
      ...
      | ((options?: RequestOptions) => Promise<Stripe.Response<Stripe.Charge>>);
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.Charge>);
...
const resource: ChargesResource = StripeResource.extend({
  path: 'charges',
