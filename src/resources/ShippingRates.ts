...
namespace Stripe {
  ...
  export interface ShippingRatesResource {
    create: (
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.ShippingRate>);
  }
}

const resource: ShippingRatesResource = StripeResource.extend({
  path: 'shipping_rates',
