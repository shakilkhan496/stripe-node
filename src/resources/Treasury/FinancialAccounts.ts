...
namespace Stripe {
  namespace Treasury {
    ...
    export interface FinancialAccountsResource {
      create: (
      ...
      retrieveFeatures:
        | ((
            ...
            Stripe.Response<Stripe.Treasury.FinancialAccountFeatures>
          >)
        | ((
            id: string,
            options?: RequestOptions
...
const resource: FinancialAccountsResource = StripeResource.extend({
