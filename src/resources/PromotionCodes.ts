...
namespace Stripe {
  ...
  export interface PromotionCodesResource {
    create: (
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.PromotionCode>);
  }
}

const resource: PromotionCodesResource = StripeResource.extend({
