...
namespace Stripe {
  ...
  export interface OrderListLineItemsParams extends PaginationParams {
    /**
     * Specifies which fields in the response should be expanded.
     */
    expand?: Array<string>;
  ...
  export interface OrderReopenParams {
    /**
     * Specifies which fields in the response should be expanded.
     */
    expand?: Array<string>;
  ...
  export interface OrdersResource {
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.Order>);
...
const resource: OrdersResource = StripeResource.extend({
  path: 'orders',
