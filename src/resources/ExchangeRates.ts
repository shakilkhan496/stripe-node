...
namespace Stripe {
  ...
  export interface ExchangeRatesResource {
    retrieve:
      | ((
          id: string,
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.ExchangeRate>);
  }
}

const resource: ExchangeRatesResource = StripeResource.extend({
  path: 'exchange_rates',
