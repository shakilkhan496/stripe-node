...
namespace Stripe {
  ...
  export interface QuotesResource {
    create:
      ...
      | ((options?: RequestOptions) => Promise<Stripe.Response<Stripe.Quote>>);
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.Quote>);
...
const resource: QuotesResource = StripeResource.extend({
  path: 'quotes',
