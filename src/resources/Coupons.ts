...
namespace Stripe {
  ...
  export interface CouponsResource {
    create:
      ...
      | ((options?: RequestOptions) => Promise<Stripe.Response<Stripe.Coupon>>);
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.Coupon>);
...
const resource: CouponsResource = StripeResource.extend({
  path: 'coupons',
