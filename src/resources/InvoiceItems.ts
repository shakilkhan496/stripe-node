...
namespace Stripe {
  ...
  export interface InvoiceItemsResource {
    create: (
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.InvoiceItem>);
...
const resource: InvoiceItemsResource = StripeResource.extend({
  path: 'invoiceitems',
