...
namespace Stripe {
  ...
  export interface InvoiceCreateParams {
     ...
     * Options for invoice PDF rendering.
     */
    rendering_options?: Stripe.Emptyable<InvoiceCreateParams.RenderingOptions>;
  ...
  export interface InvoiceUpdateParams {
     ...
     * Options for invoice PDF rendering.
     */
    rendering_options?: Stripe.Emptyable<InvoiceUpdateParams.RenderingOptions>;
  ...
  namespace InvoiceListUpcomingLinesParams {
    ...
    export interface SubscriptionItem {
       ...
       */
      billing_thresholds?: Stripe.Emptyable<SubscriptionItem.BillingThresholds>;
  ...
  export interface InvoiceListUpcomingLinesParams extends PaginationParams {
     ...
     */
    subscription_items?: Array<InvoiceListUpcomingLinesParams.SubscriptionItem>;
  ...
  export interface InvoiceRetrieveUpcomingParams {
     ...
     * The coupons to redeem into discounts for the invoice preview. If not specified, inherits the discount from the customer or subscription. This only works for coupons directly applied to the invoice. To apply a coupon to a subscription, you must use the `coupon` parameter instead. Pass an empty string to avoid inheriting any discounts. To preview the upcoming invoice for a subscription that hasn't been created, use `coupon` instead.
     */
    discounts?: Stripe.Emptyable<Array<InvoiceRetrieveUpcomingParams.Discount>>;
  ...
  export interface InvoicesResource {
    ...
    list:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.Invoice>);
    ...
    listUpcomingLines:
      ...
      | ((options?: RequestOptions) => ApiListPromise<Stripe.InvoiceLineItem>);
...
const resource: InvoicesResource = StripeResource.extend({
  path: 'invoices',
